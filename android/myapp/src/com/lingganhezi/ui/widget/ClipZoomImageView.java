...

{
	 ...
	 * 重置 Drawable 的位置大小
	 */
	private void resetDrawableMatrix() {
		Drawable d = getDrawable();
		if (d == null)
			return;
		// 垂直方向的边距
	...
	public Bitmap clip() {
		...
		// TODO 切成圆形
		// 缩放
		final int outputLength = Constant.PERSONAL_AVATAR_CLIP_LENGTH;
		int targetBitmapLength = getWidth() - 2 * mHorizontalPadding;
		float scale = Float.valueOf(outputLength) / targetBitmapLength;
		Matrix m = new Matrix();
